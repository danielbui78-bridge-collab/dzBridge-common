...
{
	bool bResult = true;
	TRY_METHODCALL(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->resetToDefaults());
	return true;
}
...
{
	bool bResult = true;
	TRY_METHODCALL_NULLPTR(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->cleanString(nullptr));

	TRY_METHODCALL_CUSTOM(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->cleanString(""), "C++ exception with empty string test.");
...
{
	bool bResult = true;
	TRY_METHODCALL(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->getAvailableMorphs(new DzNode()));

	TRY_METHODCALL_NULLPTR(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->getAvailableMorphs(nullptr));
...
{
	bool bResult = true;
	TRY_METHODCALL(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->getActiveMorphs(new DzNode()));

	TRY_METHODCALL_NULLPTR(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->getActiveMorphs(nullptr));
...
{
	bool bResult = true;
	TRY_METHODCALL(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->makeNormalMapFromHeightMap(nullptr, 0.0));
...
{
	bool bResult = true;
	TRY_METHODCALL(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->preProcessScene(new DzNode()));

	TRY_METHODCALL_NULLPTR(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->preProcessScene(nullptr));
...
{
	bool bResult = true;
	TRY_METHODCALL_NULLPTR(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->renameDuplicateMaterial(nullptr, nullptr));
...
{
	bool bResult = true;
	TRY_METHODCALL(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->undoRenameDuplicateMaterials());
...
{
	bool bResult = true;
	TRY_METHODCALL_NULLPTR(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->generateMissingNormalMap(nullptr));
...
{
	bool bResult = true;
	TRY_METHODCALL(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->undoGenerateMissingNormalMaps());
...
{
	bool bResult = true;
	TRY_METHODCALL(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->getActionGroup());
...
{
	bool bResult = true;
	TRY_METHODCALL(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->getDefaultMenuPath());
...
{
	bool bResult = true;
	TRY_METHODCALL(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->exportAsset());
...
{
	bool bResult = true;
	TRY_METHODCALL(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->exportNode(new DzNode()));

	TRY_METHODCALL_NULLPTR(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->exportNode(nullptr));
...
{
	bool bResult = true;
	TRY_METHODCALL(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->writeConfiguration());
...
bool UnitTest_DzBridgeAction::setExportOptions(UnitTest::TestResult* testResult)
{
	...
	TRY_METHODCALL(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->setExportOptions(arg));
...
{
	bool bResult = true;
	TRY_METHODCALL(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->readGuiRootFolder());
...
bool UnitTest_DzBridgeAction::writeDtuHeader(UnitTest::TestResult* testResult)
{
	...
	TRY_METHODCALL(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->writeDTUHeader(arg));
...
bool UnitTest_DzBridgeAction::startMaterialBlock(UnitTest::TestResult* testResult)
{
	bool bResult = true;
	DzJsonWriter arg(nullptr);
	TRY_METHODCALL_NULLPTR(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->startMaterialBlock(nullptr, arg, nullptr, nullptr));
...
bool UnitTest_DzBridgeAction::finishMaterialBlock(UnitTest::TestResult* testResult)
{
	bool bResult = true;
	DzJsonWriter arg(nullptr);
	TRY_METHODCALL(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->finishMaterialBlock(arg));
...
bool UnitTest_DzBridgeAction::writeAllMaterials(UnitTest::TestResult* testResult)
{
	bool bResult = true;
	DzJsonWriter arg(nullptr);
	TRY_METHODCALL_NULLPTR(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->writeAllMaterials(nullptr, arg));
...
bool UnitTest_DzBridgeAction::writeMaterialProperty(UnitTest::TestResult* testResult)
{
	bool bResult = true;
	DzJsonWriter arg(nullptr);
	TRY_METHODCALL_NULLPTR(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->writeMaterialProperty(nullptr, arg, nullptr, nullptr, nullptr));
...
bool UnitTest_DzBridgeAction::writeAllMorphs(UnitTest::TestResult* testResult)
{
	bool bResult = true;
	DzJsonWriter arg(nullptr);
	TRY_METHODCALL(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->writeAllMorphs(arg));
...
bool UnitTest_DzBridgeAction::writeMorphProperties(UnitTest::TestResult* testResult)
{
	bool bResult = true;
	DzJsonWriter arg(nullptr);
	TRY_METHODCALL(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->writeMorphProperties(arg, "", ""));
...
bool UnitTest_DzBridgeAction::writeMorphJointLinkInfo(UnitTest::TestResult* testResult)
{
	...
	JointLinkInfo arg2;
	TRY_METHODCALL(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->writeMorphJointLinkInfo(arg1, arg2));
...
bool UnitTest_DzBridgeAction::writeAllSubdivisions(UnitTest::TestResult* testResult)
{
	bool bResult = true;
	DzJsonWriter arg(nullptr);
	TRY_METHODCALL(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->writeAllSubdivisions(arg));
...
bool UnitTest_DzBridgeAction::writeSubdivisionProperties(UnitTest::TestResult* testResult)
{
	bool bResult = true;
	DzJsonWriter arg(nullptr);
	TRY_METHODCALL(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->writeSubdivisionProperties(arg, "", 0));
...
bool UnitTest_DzBridgeAction::writeAllDforceInfo(UnitTest::TestResult* testResult)
{
	bool bResult = true;
	DzJsonWriter arg(nullptr);
	TRY_METHODCALL_NULLPTR(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->writeAllDforceInfo(nullptr, arg));
...
bool UnitTest_DzBridgeAction::writeDforceMaterialProperties(UnitTest::TestResult* testResult)
{
	bool bResult = true;
	DzJsonWriter arg(nullptr);
	TRY_METHODCALL_NULLPTR(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->writeDforceMaterialProperties(arg, nullptr, nullptr));
...
bool UnitTest_DzBridgeAction::writeDforceModifiers(UnitTest::TestResult* testResult)
{
	...
	DzJsonWriter arg1(nullptr);
	DzModifierList arg2;
	TRY_METHODCALL_NULLPTR(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->writeDforceModifiers(arg2, arg1, nullptr));
...
bool UnitTest_DzBridgeAction::writeEnvironment(UnitTest::TestResult* testResult)
{
	bool bResult = true;
	DzJsonWriter arg(nullptr);
	TRY_METHODCALL(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->writeEnvironment(arg));
...
bool UnitTest_DzBridgeAction::writeInstances(UnitTest::TestResult* testResult)
{
	...
	TRY_METHODCALL_NULLPTR(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->writeInstances(nullptr, arg1, arg2, arg3));
...
bool UnitTest_DzBridgeAction::writeInstance(UnitTest::TestResult* testResult)
{
	bool bResult = true;
	DzJsonWriter arg(nullptr);
	TRY_METHODCALL_NULLPTR(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->writeInstance(nullptr, arg, 0));
...
bool UnitTest_DzBridgeAction::writeAllPoses(UnitTest::TestResult* testResult)
{
	bool bResult = true;
	DzJsonWriter arg(nullptr);
	TRY_METHODCALL(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->writeAllPoses(arg));
...
bool UnitTest_DzBridgeAction::renameDuplicateMaterials2(UnitTest::TestResult* testResult)
{
	...
	TRY_METHODCALL_NULLPTR(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->renameDuplicateMaterials(nullptr, arg1, arg2));
...
bool UnitTest_DzBridgeAction::undoRenameDuplicateMaterials2(UnitTest::TestResult* testResult)
{
	...
	QList<QString> arg1;
	QMap<DzMaterial*, QString> arg2;
	TRY_METHODCALL_NULLPTR(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->undoRenameDuplicateMaterials(nullptr, arg1, arg2));
...
bool UnitTest_DzBridgeAction::getScenePropList(UnitTest::TestResult* testResult)
{
	...
	TRY_METHODCALL_NULLPTR(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->getScenePropList(nullptr, arg));
...
{
	bool bResult = true;
	QList<DzUnrealNS::DzBridgeAction::AttachmentInfo> arg;
	TRY_METHODCALL_NULLPTR(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->disconnectNode(nullptr, arg));
...
bool UnitTest_DzBridgeAction::reconnectNodes(UnitTest::TestResult* testResult)
{
	bool bResult = true;
	QList<DzUnrealNS::DzBridgeAction::AttachmentInfo> arg;
	TRY_METHODCALL(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->reconnectNodes(arg));
...
{
	bool bResult = true;
	TRY_METHODCALL(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->disconnectOverrideControllers());
...
bool UnitTest_DzBridgeAction::reconnectOverrideControllers(UnitTest::TestResult* testResult)
{
	bool bResult = true;
	QList<QString> arg;
	TRY_METHODCALL(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->reconnectOverrideControllers(arg));
...
{
	bool bResult = true;
	TRY_METHODCALL(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->checkIfPoseExportIsDestructive());
...
{
	bool bResult = true;
	TRY_METHODCALL_NULLPTR(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->unlockTranform(nullptr));
...
{
	bool bResult = true;
	TRY_METHODCALL(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->getBridgeDialog());
...
{
	bool bResult = true;
	TRY_METHODCALL_NULLPTR(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->setBridgeDialog(nullptr));
...
{
	bool bResult = true;
	TRY_METHODCALL(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->getSubdivisionDialog());
...
{
	bool bResult = true;
	TRY_METHODCALL_NULLPTR(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->setSubdivisionDialog(nullptr));
...
{
	bool bResult = true;
	TRY_METHODCALL(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->getMorphSelectionDialog());
...
{
	bool bResult = true;
	TRY_METHODCALL_NULLPTR(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->setMorphSelectionDialog(nullptr));
...
{
	bool bResult = true;
	TRY_METHODCALL(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->getAssetType());
...
{
	bool bResult = true;
	TRY_METHODCALL(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->setAssetType(""));

	TRY_METHODCALL_NULLPTR(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->setAssetType(nullptr));
...
{
	bool bResult = true;
	TRY_METHODCALL(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->getExportFilename());
...
{
	bool bResult = true;
	TRY_METHODCALL(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->setExportFilename(""));

	TRY_METHODCALL_NULLPTR(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->setExportFilename(nullptr));
...
{
	bool bResult = true;
	TRY_METHODCALL(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->getExportFolder());
...
{
	bool bResult = true;
	TRY_METHODCALL(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->setExportFolder(""));
...
{
	bool bResult = true;
	TRY_METHODCALL(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->getRootFolder());
...
{
	bool bResult = true;
	TRY_METHODCALL(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->setRootFolder(""));
...
{
	bool bResult = true;
	TRY_METHODCALL(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->getProductName());
...
{
	bool bResult = true;
	TRY_METHODCALL(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->setProductName(""));
...
{
	bool bResult = true;
	TRY_METHODCALL(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->getProductComponentName());
...
{
	bool bResult = true;
	TRY_METHODCALL(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->setProductComponentName(""));
...
{
	bool bResult = true;
	TRY_METHODCALL(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->getMorphList());
...
bool UnitTest_DzBridgeAction::setMorphList(UnitTest::TestResult* testResult)
{
	bool bResult = true;
	QStringList arg;
	TRY_METHODCALL(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->setMorphList(arg));
...
{
	bool bResult = true;
	TRY_METHODCALL(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->getUseRelativePaths());
...
{
	bool bResult = true;
	TRY_METHODCALL(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->setUseRelativePaths(0));
...
{
	bool bResult = true;
	TRY_METHODCALL(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->isTemporaryFile(""));
...
{
	bool bResult = true;
	TRY_METHODCALL(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->exportAssetWithDtu(""));
...
bool UnitTest_DzBridgeAction::writePropertyTexture(UnitTest::TestResult* testResult)
{
	bool bResult = true;
	DzJsonWriter arg(nullptr);
	TRY_METHODCALL(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->writePropertyTexture(arg,"",0,"",""));
...
{
	bool bResult = true;
	TRY_METHODCALL(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->makeUniqueFilename(""));
...
{
	bool bResult = true;
	TRY_METHODCALL(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->getUndoNormalMaps());
...
{
	bool bResult = true;
	TRY_METHODCALL(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->setUndoNormalMaps(0));
...
{
	bool bResult = true;
	TRY_METHODCALL(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->getNonInteractiveMode());
...
{
	bool bResult = true;
	TRY_METHODCALL(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->setNonInteractiveMode(0));
...
{
	bool bResult = true;
	TRY_METHODCALL(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->getExportFbx());
...
{
	bool bResult = true;
	TRY_METHODCALL(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->setExportFbx(""));
...
{
	bool bResult = true;
	TRY_METHODCALL_NULLPTR(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->readGui(nullptr));
...
bool UnitTest_DzBridgeAction::exportHD(UnitTest::TestResult* testResult)
{
	...
	arg->enable(false);
	TRY_METHODCALL(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->exportHD(arg));
	arg->finish();
...
{
	bool bResult = true;
	TRY_METHODCALL(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->setNonInteractiveMode(true));
	TRY_METHODCALL_NULLPTR(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->upgradeToHD("","", "", nullptr));
...
bool UnitTest_DzBridgeAction::writeWeightMaps(UnitTest::TestResult* testResult)
{
	bool bResult = true;
	DzJsonWriter arg(nullptr);
	TRY_METHODCALL_NULLPTR(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->writeWeightMaps(nullptr, arg));
...
{
	bool bResult = true;
	TRY_METHODCALL_NULLPTR(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->metaInvokeMethod(nullptr, nullptr, nullptr));
...
{
	bool bResult = true;
	TRY_METHODCALL_NULLPTR(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->copyFile(nullptr, nullptr));
...
{
	bool bResult = true;
	TRY_METHODCALL(qobject_cast<DzUnrealNS::DzBridgeAction*>(m_testObject)->getMD5(""));
